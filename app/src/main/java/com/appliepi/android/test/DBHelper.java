...
/**
 * Created by ilhoon on 05/02/2017.
 */
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void insert(String name, String subject, String job, String room) {
        // 읽고 쓰기가 가능하게 DB 열기
        SQLiteDatabase db = getWritableDatabase();
        // DB에 입력한 값으로 행 추가
        db.execSQL("INSERT INTO MONEYBOOK VALUES(null, '" + name + "', " + subject + ", '" + job + "', " + room + ");");
        db.close();
    }
